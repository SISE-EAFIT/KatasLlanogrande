...
%
% Con ese libro tienen para sacar casi toda la informacion
%
% Muchas gracias
...
\begin{document}
    ...
    \input{Frames/InterpretadoInfo}
    \input{Frames/InferenciaInfo}
    \input{Frames/IndentacionInfo}
    \input{Frames/Tipos}
    \input{Frames/Colecciones}
